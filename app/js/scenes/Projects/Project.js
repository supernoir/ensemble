					...
					<SegmentGroup horizontal>
						...
						{this.props.project.type !== void 0
							? <Segment>
								...
								<Label
									color={'black'}
									size={'large'}
									content={intl.get(this.props.project.type !== void 0 ? `project.select-type-${this.props.project.type}` : 'project.select-type-novel')}
									icon={'compass'}
								/>
						...
						{this.props.project.status !== void 0
							? <Segment>
								...
								<Label
									...
									size={'large'}
									content={intl.get(`project.status-${this.props.project.status}` || 'project.status-inprogress')}
									icon="thumbtack"
								/>
							</Segment>
							: null}
						{this.props.project.series !== void 0 && this.props.project.series.length > 0
							? <Segment>
								...
								<Label size={'large'} content={this.props.project.series} icon="paperclip" />
							</Segment>
							: null}
					</SegmentGroup>
